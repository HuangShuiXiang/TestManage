 ...
 */
public class ViewGroupCustomThree extends ViewGroup {
    /**
     * 屏幕的高度
     */
    ...
    public ViewGroupCustomThree(Context context, AttributeSet attrs) {
        super(context, attrs);

        /**
         * 获得屏幕的高度
         */
        mScreenHeight = AppConfig.getInstance(getContext()).SCREEN_HEIGHT;
        // 初始化
